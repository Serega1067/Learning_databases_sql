...
CREATE SCHEMA databases_sql_homework5;

USE databases_sql_homework5;
...
(	
 ...
 -- AUTO
INSERT INTO AUTO (REGNUM, MARK,	COLOR, PRICE, RELEASEDT, PHONENUM ) VALUES
...
DROP VIEW auto_price;
CREATE OR REPLACE VIEW auto_price AS
	SELECT *
    FROM AUTO
    WHERE PRICE < 25000;
SELECT *
...
DROP VIEW auto_name;
CREATE OR REPLACE VIEW auto_name AS
	SELECT *
    FROM AUTO
