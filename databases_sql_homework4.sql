...
CREATE SCHEMA databases_sql_homework4;

USE databases_sql_homework4;
...
SELECT MARK, COLOR, COUNT(COLOR) AS 'COUNT CARS'
FROM auto
WHERE MARK = 'BMW'
GROUP BY MARK, COLOR
UNION SELECT MARK, COLOR, COUNT(COLOR) AS 'COUNT CARS'
FROM auto
WHERE MARK = 'LADA'
GROUP BY MARK, COLOR;

-- 2. Вывести на экран марку авто и количество AUTO не этой марки.
SELECT MARK, (SELECT COUNT(REGNUM) FROM auto) - COUNT(MARK) AS 'COUNT CARS'
FROM auto
GROUP BY MARK;
